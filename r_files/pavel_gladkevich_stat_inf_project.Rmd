---
title: "Statistical inference with the GSS data - Pavel Gladkevich, 2018"
output: 
  html_document: 
    fig_height: 4
    highlight: pygments
...
Because the variables of tvhours and generations are continous and catgeogrical, we will need use the ANOVA (analysis of variance) methodology to compare the two. This single hypothesis test will compare the mean value of tvhours watched is the same across the different generations. As taken from our textbook:
