...
gt <- table(ger12$response)
prop.table(gt)

nger = length(ger12$response)
pger = sum(ger12$response=="atheist")/nger

pger*nger

#conditions met because lowest n is 75, which is greater than 10

inference(y=response, data=ger12, statistic = "proportion", type="ci", conf_level= .95, method="theoretical", success="atheist")
```
...
inference(y=response, x=as.factor(year), data=sp5t12, statistic="proportion", type="ht",null=0, alternative ="twosided", method="theoretical", success="atheist")
```
...
inference(y=response, x=as.factor(year), data=us5t12, statistic="proportion", type="ht",null=0, alternative ="twosided", method="theoretical", success="atheist")
```
