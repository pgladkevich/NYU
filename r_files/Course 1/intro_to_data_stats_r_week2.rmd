...
```{r sfo-feb-flights}
# type your code for Question 1 here, and Knit. answer = 68
sfo_feb_flights <- nycflights %>%
  filter(dest == "SFO" , month == 2)
```
...
# type your code for Question 2 here, and Knit. Answer = No flight is delayed more than 2 hours.
...
# type your code for Question 3 here, and Knit. Answer = Delta and United Airlines
sfo_feb_flights %>%
  group_by(carrier) %>%
...
# type your code for Question 5 here, and Knit. Answer is December.
nycflights %>%
  group_by(month) %>%
...
# type your code for Question 8 here, and Knit. Answer is N666DN
nycflights <- nycflights %>% 
...
# type your code for Question 9 here, and Knit. Answer is There is an overall...
...
```{r on-time-arr-perc}
# type your code for Question 10 here, and Knit. Answer is 77.62%.
nycflights <- nycflights %>%
  mutate (arr_type = ifelse(arr_delay <= 0, "on time", "delayed"))
nycflights %>%
  group_by(dep_type) %>%
  summarise(ot_arrival_perc = sum(arr_type == "on time")/ n()) %>%
  arrange(desc(ot_arrival_perc))
